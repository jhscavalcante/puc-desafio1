    ...
    <form onSubmit={submitHandler}>
      ...
      <div className='form-group'>
        <div className='d-flex'>
          <input
            type='text'
            name='firstname'
            className='form-control-input is-invalid'
            placeholder={t('register_form_field_firstname')}
            value={firstname}
          ...
          <input
            ...
            placeholder={t('register_form_field_lastname')}
            value={lastname}
      ...
      <div className='form-group'>
        <input
          ...
          name='email'
          className={`form-control-input ${
            emailState.isValid ? 'valid' : 'invalid'
          }`}
          placeholder={t('register_form_field_email')}
      ...
      <div className='form-group'>
        <input
          ...
          name='password'
          className='form-control-input'
          placeholder={t('register_form_field_password')}
          value={password}
      ...
      <div className='form-group'>
        ...
        >
          {t('register_form_field_btn_save')}
        </button>
      </div>
    </form>
  )
