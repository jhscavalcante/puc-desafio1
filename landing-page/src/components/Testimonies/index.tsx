...
export const Testimonies = () => {
    ...
    const [testimonies, setTestimonies] = useState<Testimonial[]>(testimoniesMockData)
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-12">
                        ...
                        { testimonies && testimonies.map((testimonial: Testimonial) => {
                            return (
                            <div className="card" key={testimonial.id}>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="occupation">{testimonial.occupation}, {testimonial.state}</div>
                                </div>
